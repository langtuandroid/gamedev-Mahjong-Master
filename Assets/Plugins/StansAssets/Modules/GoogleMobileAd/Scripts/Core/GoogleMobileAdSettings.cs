...
public class GoogleMobileAdSettings : ScriptableObject {
	...
	public const string VERSION_NUMBER = "10.0/" + SA.Common.Config.LIB_VERSION;
	public const string PLAY_SERVICE_VERSION = "11.4.2";
	public const string PLAY_SERVICE_VERSION_NUMBER = "11400000";
	...
	public static string downloadSDKLink = "https://developers.google.com/admob/ios/download";
